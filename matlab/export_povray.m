...
camera = ['camera {location ' pov_vect(camera_pos) ' look_at ' pov_vect(center) ' angle 40}'];
...
epsilon = 1; % FIXME this should be small compared to any other linear dimension of any object in the scene
str = ['prism { linear_spline linear_sweep ' num2str(Elevation - epsilon) ', ' num2str(Elevation + epsilon) ', ' num2str(numel(CSX_polygon.Vertex))];
