...
public:
	...
	CSPropExcitation(CSPropExcitation* prop, bool copyPrim=false);
	...
	virtual CSProperties* GetCopy(bool incl_prim=false) {return new CSPropExcitation(this, incl_prim);}
