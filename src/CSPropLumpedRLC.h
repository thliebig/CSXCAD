...
/*!
  ...
  */
class CSXCAD_EXPORT CSPropLumpedRLC : public CSProperties
{
public:
	CSPropLumpedRLC(ParameterSet* paraSet);
	CSPropLumpedRLC(CSProperties* prop);
	CSPropLumpedRLC(unsigned int ID, ParameterSet* paraSet);
	virtual ~CSPropLumpedRLC();
	...
	void SetRLCtype(RLCtype c_RLCtype);
	RLCtype GetRLCtype() const {return e_RLCtype; };
	...
	virtual const std::string GetTypeXMLString() const {return std::string("LumpedRLC");}
